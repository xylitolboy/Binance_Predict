...
class Extract_spot_data: 
    ...
    def download_binance_spot_data(self):
        # DB 초기화
        ...
        if self.symbols == "all":
            ...
            self.symbols = [i for i in self.symbols if "USDT" in i]
            self.symbols = [i for i in self.symbols if ":USDT" not in i]
